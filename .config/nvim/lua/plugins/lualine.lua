		...
		require("lualine").setup({
			...
			sections = {
				...
				lualine_x = {
					...
					{ "'󰙨 ' .. vim.g.xcodebuild_test_plan", color = { fg = "#a6e3a1", bg = "" } },
					{ xcodebuild_device, color = { fg = "#f9e2af", bg = "" } },
					{ lsp_servers, icon = "", color = { fg = "" } },
					{ word_count, icon = "󰈭", color = { fg = "" } },
					{ indent_size, icon = "󰞔", color = { fg = "" } },
					{ "encoding", icon = "󰯃" },
					{ "filetype", icon = "" },
				},
				lualine_y = { "progress" },
